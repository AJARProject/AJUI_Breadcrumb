...
If (False:C215)
	  ...
	  // Date and time: 02.12.19, 14:09:10
	  // ----------------------------------------------------
...
$file:=Folder:C1567(fk user preferences folder:K87:10).folder("AJUI_BreadCrumbTempPref").file("AJUI_BreadCrumbTempPref.json")
$globalPath:=Get 4D folder:C485(Current resources folder:K5:16;*)+"AJUI_BreadCrumb_Templates"+Folder separator:K24:12
If ($file.exists)
